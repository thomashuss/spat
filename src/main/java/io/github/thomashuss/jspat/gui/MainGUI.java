...
import io.github.thomashuss.jspat.editor.Editor;
import io.github.thomashuss.jspat.library.Library;
import io.github.thomashuss.jspat.library.LibraryResource;
import io.github.thomashuss.jspat.library.SaveDirectory;
import io.github.thomashuss.jspat.library.SaveFileException;
        ...
        implements PropertyChangeListener
{
    ...
    {
        String clientId = shouldForce ? null : JSpat.preferences.get(JSpat.P_CLIENT_ID, null);
        if (clientId == null) {
            while (clientId == null) {
        ...
        String redirectUriString = shouldForce ? null : JSpat.preferences.get(JSpat.P_REDIRECT_URI, null);
        ...
        JSpat.preferences.put(JSpat.P_CLIENT_ID, clientId);
        if (redirectUri != null) JSpat.preferences.put(JSpat.P_REDIRECT_URI, redirectUri.toString());
    ...
    {
        String path = JSpat.preferences.get(JSpat.P_FILE_PATH, null);
        if (path != null) {
    ...
    private void openLibrary()
    {
        ...
        if (chooser.showOpenDialog(this) == JFileChooser.APPROVE_OPTION) {
            try {
                ...
                JSpat.preferences.put(JSpat.P_FILE_PATH, saveDirectory.getAbsolutePath());
