...
import io.github.thomashuss.jspat.client.Token;
...
public class SaveDirectory
{
    ...
    throws SaveFileException, IOException
    {
        ...
        SaveDirectory state = stateFile.exists()
                ? JSpat.mapper.readValue(stateFile, SaveDirectory.class) : new SaveDirectory();
        state.dbDir = dbDir;
    ...
    throws IOException
    {
        JSpat.mapper.writeValue(stateFile, this);
    }
}
