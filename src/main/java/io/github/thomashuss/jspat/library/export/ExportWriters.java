...
{
    public static final ObjectWriter jsonWriter = JSpat.mapper.writer();
    public static final ObjectWriter savedTrackCsvWriter = JSpat.csvMapper.writer(
            JSpat.csvMapper.schemaFor(SavedTrack.class).withHeader());
    public static final ObjectWriter savedAlbumCsvWriter = JSpat.csvMapper.writer(
            JSpat.csvMapper.schemaFor(SavedAlbum.class).withHeader());

    static {
        JSpat.csvMapper.addMixIn(Album.class, AlbumCsvMixin.class);
        JSpat.csvMapper.addMixIn(Artist.class, ArtistCsvMixin.class);
        JSpat.csvMapper.addMixIn(Track.class, TrackCsvMixin.class);
        JSpat.mapper.addMixIn(Album.class, AlbumMixin.class);
        JSpat.mapper.addMixIn(Artist.class, ArtistMixin.class);
        JSpat.mapper.addMixIn(Genre.class, GenreMixin.class);
        JSpat.mapper.addMixIn(Track.class, TrackMixin.class);
    }
